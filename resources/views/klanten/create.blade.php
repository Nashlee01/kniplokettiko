...
<div class="form-page">
    <div class="form-card">
        ...
        <form action="{{ route('klanten.store') }}" method="POST" id="klantForm">
            ...
            <input id="voornaam" type="text" name="voornaam" value="{{ old('voornaam') }}" maxlength="50" pattern="[A-Za-zÀ-ÖØ-öø-ÿ][A-Za-zÀ-ÖØ-öø-ÿ' -]*" title="Voornaam moet met een letter beginnen en mag alleen letters, spaties, apostrof en koppelteken bevatten" autocomplete="given-name" required>

            <label for="achternaam">Achternaam</label>
            <input id="achternaam" type="text" name="achternaam" value="{{ old('achternaam') }}" maxlength="50" pattern="[A-Za-zÀ-ÖØ-öø-ÿ][A-Za-zÀ-ÖØ-öø-ÿ' -]*" title="Achternaam moet met een letter beginnen en mag alleen letters, spaties, apostrof en koppelteken bevatten" autocomplete="family-name" required>

            <label for="email">E-mail</label>
            <input id="email" type="email" name="email" value="{{ old('email') }}" maxlength="100" autocomplete="email" required>
            ...
            <input id="telefoon" type="tel" name="telefoon" value="{{ old('telefoon') }}" maxlength="20" pattern="[0-9+\-\s]{8,20}" autocomplete="tel" required>
            ...
            <input id="straatnaam" type="text" name="straatnaam" value="{{ old('straatnaam') }}" maxlength="50" autocomplete="address-line1" required>

            <label for="huisnummer">Huisnummer</label>
            <input id="huisnummer" type="number" name="huisnummer" value="{{ old('huisnummer') }}" min="1" step="1" required>

            <label for="postcode">Postcode</label>
            <input id="postcode" type="text" name="postcode" value="{{ old('postcode') }}" maxlength="10" pattern="[0-9]{4}\s?[A-Za-z]{2}" autocomplete="postal-code" required>
            ...
            <input id="plaats" type="text" name="plaats" value="{{ old('plaats') }}" maxlength="50" autocomplete="address-level2" required>
